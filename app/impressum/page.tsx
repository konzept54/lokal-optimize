...
export const metadata: Metadata = {
  title: 'Impressum',
  description: 'Impressum von Local Optimize – Friederike Holzhauser, Badstr. 16, 77866 Rheinau.',
}
      ...
      <main className="pt-[72px] min-h-screen bg-brand-dark">
        <div className="max-w-2xl mx-auto px-6 py-16">
          ...
          <div className="space-y-8 text-sm text-brand-cyan/70 leading-relaxed">
            ...
            <section>
              <h2 className="text-brand-light font-bold text-base mb-2">Angaben gemäß § 5 TMG</h2>
              <p>
            ...
            <section>
              <h2 className="text-brand-light font-bold text-base mb-2">Kontakt</h2>
              <p>
                Telefon:{' '}
            ...
            <section>
              <h2 className="text-brand-light font-bold text-base mb-2">Umsatzsteuer-ID</h2>
              <p>
            ...
            <section>
              <h2 className="text-brand-light font-bold text-base mb-2">EU-Streitschlichtung</h2>
              <p>
            ...
            <section>
              <h2 className="text-brand-light font-bold text-base mb-2">Haftung für Inhalte</h2>
              <p>
            ...
            <section>
              <h2 className="text-brand-light font-bold text-base mb-2">Haftung für Links</h2>
              <p>
            ...
            <section>
              <h2 className="text-brand-light font-bold text-base mb-2">Urheberrecht</h2>
              <p>
